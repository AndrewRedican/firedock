...
### First off, thank you for considering contributing to firedock. It's people like you that make it such a great repository.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.


Firedock is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into Firedock itself.

### About Inquiries

Until our slack channel is set up, feel free to use the [issue tracker](https://github.com/AndrewRedican/firedock/issues) for support questions.

# Your First Contribution
Unsure where to begin contributing to Firedock? You can start by looking through these beginner and help-wanted issues:

* [Beginner issues](https://github.com/AndrewRedican/firedock/labels/beginner) - issues which should only require a few lines of code, and a test or two.
* [Help wanted issues](https://github.com/AndrewRedican/firedock/labels/help%20wanted) - issues which should be a bit more involved than beginner issues.
...
All pull requests should include a [CLA.md](https://github.com/AndrewRedican/firedock/blob/master/CLA.md) file
...
If you find yourself wishing for a feature that doesn't exist in Firedock, you are probably not alone. There are bound to be others out there with similar needs. The proper way to do it is to open up a new issue [here](https://github.com/AndrewRedican/firedock/issues). Please make sure to check the list of existing feature requests to avoid duplication.
...
- [ ] Do the tests pass for all of the following? If not, write a note in the PR, or fix them yourself. [**Read about testing**](https://github.com/AndrewRedican/firedock/wiki/How-to-Create-and-Run-Tests)
